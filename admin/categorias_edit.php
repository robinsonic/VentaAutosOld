...
if (isset($_GET["recordID"])) {
  $varCategoria_Recordset2 = (get_magic_quotes_gpc()) ? $_GET["recordID"] : addslashes($_GET["recordID"]);
}
mysql_select_db($database_connect, $connect);
$query_Recordset2 = sprintf("SELECT * FROM tblcategoria WHERE tblcategoria.idCategoria=%s", $varCategoria_Recordset2);
    ...
    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table align="center">
        <tr valign="baseline">
          ...
          <td><input type="text" name="strDescripcion" value="<?php echo $row_Recordset2['strDescripcion']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
      ...
      <input type="hidden" name="idCategoria" value="<?php echo $row_Recordset2['idCategoria']; ?>">
    </form>
    <p>&nbsp;</p>
